...
function NaturalSciencePage() {
    ...
    useEffect(() => {
        //a collection that will store the overall values of NaturalScience_Main
        const resourceCollectionRef = collection(db, "PDFS", "NaturalScience_Main", "naturalScience")
