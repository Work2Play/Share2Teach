...
function OtherOERsPage() {
    return (
        <div className="other-oers-page">
        <h1 className="subject-title">Other useful OER's</h1>
        <h2 className="section-subtitle">{otherOERsIntroduction}</h2>
        <div className="subject-introduction">
            <a href={merlotLink} target="_blank" rel="noopener noreferrer">
            {merlotLink}
            </a>
        </div>
