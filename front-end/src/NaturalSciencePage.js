...
function NaturalSciencePage() {
    return (
        ...
        <div className="subject-gallery">
            ...
            <tbody>
                {naturalScienceResources.map((resource, index) => (
                <tr key={index}>
...
export default NaturalSciencePage;
