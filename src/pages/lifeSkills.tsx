        ...
        <div className="math-page"> 
            ...
            <div className="subject-gallery">
                <table className="resource-table">
                    ...
                    <tbody>
                        {lifeSkiilsResources.map((resource, index) => (
                            <tr key={index}>
